    ...
    <div class="d-flex flex-column faqs">
        ...
        @if (count($socmeds))
            ...
            <div class="answer faq-2" hidden>
                <p>
                    You can send us a message on our <a href="{{ route('pages.contact') }}" class="blue-link">Contact Page</a>
                </p>

                You can also reach us on our social media:
                <div style="margin-left: 2rem; margin-top: 1rem; margin-bottom: 1rem;">
                ...
                <div style="margin-left: 2rem; margin-top: 1rem;">
                    @if (isset($socmeds['email']))
                        <div class="soc">
                            Gmail: <a href="mailto:{{ $socmeds['email'] }}" class="blue-link">{{ $socmeds['email'] }}</a>
                        </div>
                    @endif

                    @if (isset($socmeds['email_qq']))
                        <div class="soc">
                            QQ: <a href="mailto:{{ $socmeds['email_qq'] }}" class="blue-link">{{ $socmeds['email_qq'] }}</a>
                        </div>
                    @endif
                </div>
            </div>
