...
@section('pageContent')
    <div class="uk-flex uk-flex-center">
        <div class="uk-width-large uk-border-rounded uk-box-shadow-large" id="login-container">
            <span class="uk-text-center font-patrick-hand login-header">Teacher Login</span>

            <form class="uk-form-stacked uk-padding uk-padding-remove-top" action="<?php echo route('teacher.auth') ?>" method="POST" autocomplete="off">
                @csrf
...
body {
    background: url('{{ asset('/img/blue-bg.png') }}') repeat scroll;
}
